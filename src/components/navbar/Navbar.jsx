    ...
    <>
      <div className="bg-[#454545] h-28 hidden sm:block">
        <div className="w-4/5 m-auto flex flex-row justify-between p-5">
         <div>
          <h2 className="font-bold text-white text-2xl"><span className="font-mono">F</span>A<span className="font-mono">S</span>L</h2>
         </div>
         ...
         <div className="flex items-center border-r-2 pr-5 border-gray-500">
            ...
            <div>
              <p className="text-xs text-white font-semibold">No D22 Abdulwajahuni Plaza by Ado U turn,</p>
              <p className="text-xs text-gray-300 font-semibold">Karu LGA Nasarawa State Nigeria,</p>
            </div>
          </div>
          <div className="flex items-center border-r-2 pr-5 pl-2 border-gray-500">
            ...
            <div>
              <p className="text-xs text-white font-semibold">08082100835, 08092100835</p>
              <p className="text-xs text-gray-300 font-semibold">frankafrica9@gmail.com francisesale31@yahoo.co.uk</p>
            </div>
          </div>
          <div className="flex items-center border-r-2 pr-5 pl-2 border-gray-500">
            <div>
          ...
          <div className="flex items-center border-r-2 pr-5 pl-2 border-gray-500">
            <TiSocialFacebook size={20} className="text-gray-300 cursor-pointer hover:text-red-600"/>
            <IoLogoTwitter size={18} className="text-gray-300 cursor-pointer hover:text-red-600"/>
          </div>
         </div>
        </div>
      </div>
      ...
      >
        <div className="pa-10 flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <h2 className="font-bold text-2xl"><span className="font-mono">F</span>A<span className="font-mono">S</span>L</h2>
          </Link>
          ...
          <div className="hidden md:flex md:items-center md:space-x-8 rtl:space-x-reverse">
            <Link
              to="/"
              className="py-2 px-3 font-bold text-[#454545] hover:text-green-900"
              aria-current="page"
            >
              Home
            </Link>
